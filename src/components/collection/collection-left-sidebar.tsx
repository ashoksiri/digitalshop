                                            ...
                                            <div className="row">
                                                <div className="col-sm-12">
                                                    <div className="top-banner-wrapper">
                                                        <a href="#"><img src={`https://storage.sg.content-cdn.io/in-resources/479f9d71-0a21-4015-aac2-ef0b75d4cc3e/Images/userimages/Homepage_Gold_Banner_01Sep.jpg`} className="img-fluid" alt=""/></a>
