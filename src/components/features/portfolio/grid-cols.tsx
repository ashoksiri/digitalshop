...
import {photos} from '@root/api/portfolio'
...
class GridCols extends Component {
    ...
    selectImage = (index: any, type: any) => {
        this.setState({
            photoIndex: index,
            isOpen: true,
                ...
                <section className="portfolio-section grid-portfolio ratio2_3 portfolio-padding">
                    <div className="container">
                        <Tabs className="theme-tab">
                            ...
                            <TabPanel>
                                <div className="row zoom-gallery">
                                    {getFeatureImages(photos, 'fashion').map((img: any, index: any) =>
                            ...
                            <TabPanel>
                                <div className="row zoom-gallery">
                                    {getFeatureImages(photos, 'bags').map((img: any, index: any) =>
                            ...
                            <TabPanel>
                                <div className="row zoom-gallery">
                                    {getFeatureImages(photos, 'shoes').map((img: any, index: any) =>
                            ...
                            <TabPanel>
                                <div className="row zoom-gallery">
                                    {getFeatureImages(photos, 'watch').map((img: any, index: any) =>
