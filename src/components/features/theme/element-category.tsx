                        ...
                        <div className="row order-section">
                            <div className="col-sm-4 p-0">
                                <a href="#" className="image-block">
                                    <img alt="" src={`images/cat1.jpg`} className="img-fluid blur-up lazyload bg-img" />
                                </a>
                            </div>
                            <div className="col-sm-4 p-0">
                            ...
                            <div className="col-sm-4 p-0">
                                <a href="#" className="image-block">
                                    <img alt="" src={`images/cat2.jpg`} className="img-fluid blur-up lazyload bg-img" /></a>
                            </div>
                            <div className="col-sm-4 p-0">
                            ...
                            <div className="col-sm-4 p-0">
                                <a href="#" className="image-block even">
                                    <img alt="" src={`images/cat3.jpg`} className="img-fluid blur-up lazyload bg-img" /></a>
                            </div>
                            <div className="col-sm-4 p-0">
                                <div className="contain-block">
                                    <div>
