                                ...
                                <Slider {...Product4} className="product-4 product-m no-arrow">
                                    ...
                                    <div className="product-box">
                                        <div className="img-wrapper">
                                            <div className="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                    src={`images/pro3/33.jpg`}
                                                    className="img-fluid blur-up lazyload bg-img" alt="" /></a>
                                            </div>
                                            <div className="back">
                                                <a href="product-page(no-sidebar).html"><img
                                                    src={`images/pro3/34.jpg`}
                                                    className="img-fluid blur-up lazyload bg-img" alt="" /></a>
                                            </div>
                                            <div className="cart-info cart-wrap">
                                                <button data-toggle="modal" data-target="#addtocart" title="Add to cart">
                                    ...
                                    <div className="product-box">
                                        <div className="img-wrapper">
                                            ...
                                            <div className="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                    src={`images/pro3/35.jpg`}
                                                    className="img-fluid blur-up lazyload bg-img" alt="" /></a>
                                            </div>
                                            <div className="back">
                                                <a href="product-page(no-sidebar).html"><img
                                                    src={`images/pro3/36.jpg`}
                                                    className="img-fluid blur-up lazyload bg-img" alt="" /></a>
                                            </div>
                                            <div className="cart-info cart-wrap">
                                                <button data-toggle="modal" data-target="#addtocart" title="Add to cart">
                                ...
                                <Slider {...Product4} className="product-4 product-m no-arrow">
                                    <div className="product-box">
                                        <div className="img-wrapper">
                                            <div className="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                    src={`images/fashion/pro/1.jpg`}
                                                    className="img-fluid blur-up lazyload bg-img" alt="" /></a>
                                            </div>
                                            <div className="cart-info cart-wrap">
                                                <button title="Add to cart"><i className="fa fa-shopping-cart"></i></button>
                                                <a href="#" title="Add to Wishlist"><i className="fa fa-heart"
                                                                                                        aria-hidden="true"></i></a>
