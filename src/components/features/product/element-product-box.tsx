                ...
                <section className="ratio_asos section-b-space">
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col">
                                <Slider {...Product4} className="product-4 product-m no-arrow">
                                    { products.slice(16, 20).map((product: any, index: any) =>
                                        <div className="col-xl-3 col-md-6 col-grid-box">
                ...
                <section className="ratio_asos metro-section portfolio-section light-layout section-b-space">
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col">
                                <Slider {...Product4} className="product-4 product-m no-arrow">
                                    { products.slice(10, 15).map((product: any, index: any) =>
                                        <div className="col-xl-3 col-md-6 col-grid-box">
                ...
                <section className="ratio_square section-b-space">
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col">
                                <Slider {...Product4} className="product-4 product-m no-arrow">
                                    { products.slice(20, 25).map((product: any, index: any) =>
                                        <div className="col-xl-3 col-md-6 col-grid-box">
                        ...
                        <div className="row">
                            <div className="col">
                                <Slider {...Product5} className="product-5 product-m no-arrow">
                                    { products.slice(25, 30).map((product: any, index: any) =>
                                        <div className="col-xl-3 col-md-6 col-grid-box">
                        ...
                        <div className="row">
                            <div className="col">
                                <Slider {...Product5} className="product-5 game-product product-m no-arrow">
                                    { products.slice(30, 36).map((product: any, index: any) =>
                                        <div className="col-xl-3 col-md-6 col-grid-box">
