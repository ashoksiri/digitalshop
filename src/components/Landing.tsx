...
class Landing extends Component<IProps, IState> {
    ...
    componentDidMount() {
        ...
        setTimeout(function () {
            //document.getElementById("splin-loader")?.style = "display: none";
            console.log(document.getElementById("spin-loader"))
            document.getElementById("spin-loader")?.setAttribute("style", `display:none` );
        }, 2000);
        ...
        (sky as any).addEventListener('mousemove', function (e: any) {
            var pageX = e.clientX - window.innerWidth / 2,
                pageY = e.clientY - window.innerHeight / 2;
            (elemOne as any).style.transform = 'translateX(' + (7 + pageX / 150) + '%) translateY(' + (1 + pageY / 150) + '%)';
            (elemTwo as any).style.transform = 'translateX(' + (7 + pageX / 150) + '%) translateY(' + (1 + pageY / 150) + '%)';
            (elemThree as any).style.transform = 'translateX(' + (7 + pageX / 150) + '%) translateY(' + (1 + pageY / 150) + '%)';
            (elemFour as any).style.transform = 'translateX(' + (7 + pageX / 150) + '%) translateY(' + (1 + pageY / 150) + '%)';
            (elemFive as any).style.transform = 'translateX(' + (7 + pageX / 150) + '%) translateY(' + (1 + pageY / 150) + '%)';
            (elemSix as any).style.transform = 'translateX(' + (7 + pageX / 150) + '%) translateY(' + (1 + pageY / 150) + '%)';
            (elemSeven as any).style.transform = 'translateX(' + (7 + pageX / 150) + '%) translateY(' + (1 + pageY / 150) + '%)';
            (elemEight as any).style.transform = 'translateX(' + (7 + pageX / 150) + '%) translateY(' + (1 + pageY / 150) + '%)';
            (elemNine as any).style.transform = 'translateX(' + (7 + pageX / 150) + '%) translateY(' + (1 + pageY / 150) + '%)';
            (elemTen as any).style.transform = 'translateX(' + (7 + pageX / 150) + '%) translateY(' + (1 + pageY / 150) + '%)';
            (elemEleven as any).style.transform = 'translateX(' + (7 + pageX / 150) + '%) translateY(' + (1 + pageY / 150) + '%)';
        });
    }
                        ...
                        <Tabs className="theme-tab">
                            ...
                            <TabPanel>
                                <div>
                                    <div className="row">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`/vegetables`} target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`/electronic`} target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`/furniture`} target="_blank">
                            ...
                            <TabPanel>
                                <div>
                                    <div className="row">
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`/col-left/product/1`} target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`/column/product/1`} target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`/accordian/product/1`} target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`/left-image/product/1`} target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`/left-sidebar/product/1`} target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`/no-sidebar/product/1`} target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`/right-image/product/1`} target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`/right-sidebar/product/1`} target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`/vertical/product/1`} target="_blank">
                            ...
                            <TabPanel>
                                <div>
                                    <div className="row">
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`/metro/collection`} target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`/full-width/collection`} target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`/left-sidebar/collection`} target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`/no-sidebar/collection`} target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`/right-sidebar/collection`} target="_blank">
                            ...
                            <TabPanel>
                                <div>
                                    <div className="row">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`/pages/dashboard`} target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`/pages/login`} target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`/pages/register`} target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`/pages/forgot-password`} target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`/pages/about-us`} target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`/pages/search`} target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`/pages/collection`} target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`/pages/lookbook`} target="_blank">
                            ...
                            <TabPanel>
                                <div>
                                    <div className="row">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`/blog/blog-page`} target="_blank">
                                        ...
                                        <div className="col-xl-3 col-sm-6 col-12 demo-box">
                                            <Link to={`/blog/right-sidebar`} target="_blank">
