...
class orderSuccess extends Component {
    ...
    render (){
        return (<span>Order success</span>)
        // //@ts-ignore
        // const {payment, items, symbol, orderTotal} = this.props?.location?.state;
        // const options = { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' };
        // const current = new Date();
        // const next5days = new Date(Date.now() + 5 * 86400000);
        // // @ts-ignore
        // const CheckDate = current.toLocaleDateString("en-US", options).toString()
        // // @ts-ignore
        // const deliveryDate = next5days.toLocaleDateString("en-US", options).toString()
        //
        // return (
        //     (payment)?
        //     <div>
