...
class FooterThree extends Component<IProps, IState> {
                            ...
                            <div className="col p-set">
                                <div className="footer-link">
                                    ...
                                    <div className="footer-contant">
                                        <ul>
                                            <li><Link
                                                to={`/left-sidebar/collection`}>womens</Link>
                                            </li>
                                            <li><Link
                                                to={`/left-sidebar/collection`}>clothing</Link>
                                            </li>
                                            <li><Link
                                                to={`/left-sidebar/collection`}>accessories</Link>
                                            </li>
                                            <li><Link
                                                to={`/left-sidebar/collection`}>featured</Link>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
