...
class SideBar extends Component {
            ...
            <div id="mySidenav" className="sidenav">
                ...
                <nav>
                    ...
                    <ul id="sub-menu" className="sidebar-menu">
                        <li>
                            <Link to="#" onClick={(e: any) => this.handleMegaSubmenu(e)}>
                                clothing
                        ...
                        <li>
                            <Link to="#" onClick={(e: any) => this.handleSubmenu(e)}>
                                bags
                                <span className="sub-arrow"></span>
                            </Link>
                            <ul>
                                ...
                                <li>
                                    <Link to="#" onClick={(e: any) => this.handleSubTwoMenu(e)} >
                                        purses
                                        <span className="sub-arrow"></span>
                                    </Link>
                                    <ul>
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <Link to="#" onClick={(e: any) => this.handleSubThreeMenu(e)} >
                                                accessories
                                                <span className="sub-arrow"></span>
                                            </Link>
                                            <ul>
                                                ...
                                                <li>
                                                    <Link to="#" onClick={(e: any) => this.handleSubFourMenu(e)} >
                                                        more...
                                                        <span className="sub-arrow"></span>
                                                    </Link>
                                                    <ul>
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <Link to="#" onClick={(e: any) => this.handleSuTwobmenu(e)}>
                                        more
                                        <span className="sub-arrow"></span>
                                    </Link>
                                    <ul>
    ...
    private handleSuTwobmenu(e: any) {
