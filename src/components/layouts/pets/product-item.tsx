...
import {getRelatedItems} from "@root/services";
...
class ProductItem extends Component<IProps, IState> {
    ...
    onOpenCartModal = () => {
        ...
        (this.props as any).onAddToCartClicked();
    };
    onCloseCartModal = () => {
        ...
        return (
            <div>
                <div className="product-box">
                    ...
                    <Modal open={this.state.open || false} onClose={this.onCloseModal} center>
                                            ...
                                            <div className="product-right">
                                                ...
                                                <div className="product-description border-product">
                                                    ...
                                                    <div className="size-box">
                                                        <ul>
                                                            {product.size.map((size: any, i: any) => {
                    ...
                    <div className={"cart-modal"}>
                        <Modal open={this.state.cartModalopen || false } onClose={this.onCloseCartModal} center>
                            <div className="modal-dialog modal-lg modal-dialog-centered" role="document">
                                                    ...
                                                    <div className="modal-bg addtocart">
                                                        ...
                                                        <div className="product-section">
                                                            ...
                                                            <div className="row" id="upsell_product">
                                                                {relatedItems.map((item: any,i: any) =>
