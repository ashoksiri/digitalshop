...
class Beauty extends Component<IProps,IState> {
    ...
    componentDidMount(): void {
        // console.log("ashok")
        document.getElementById("color")?.setAttribute("href", `../assets/css/color3.css` );
    }
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-xl-5 col-lg-6 col-md-12 offset-xl-1 text-center">
                                <img src={`../assets/images/beauty/about-us.jpg`} alt="" className="img-fluid blur-up lazyload" />
                            </div>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-md-8 offset-md-2">
                                ...
                                <div id={'video'} className={"modal fade video-modal"}>
                                    <Modal
                                        open={false}
